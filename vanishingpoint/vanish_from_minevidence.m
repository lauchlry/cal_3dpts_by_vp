function [vp f u0 v0] = vanish_from_minevidence(lines, imgsize)
%
...
%%计算相机内参矩阵K
%
tem1 = (vp1(1)-vp3(1))*1.0/(vp1(2)-vp3(2));
tem2 = (vp1(1)-vp2(1))*1.0/(vp1(2)-vp2(2));
tem3 = (vp3(1)-vp2(1))*1.0/(vp3(2)-vp2(2));
%fprintf('temp: %f %f %f\n', tem1, tem2, tem3);
u00 = ((vp3(2)-vp2(2))-tem1*vp2(1)+tem2*vp3(1))/(-tem1+tem2);
u01 = ((vp1(2)-vp2(2))+tem3*vp1(1)-tem1*vp2(1))/(tem3-tem1);
u02 = ((vp1(2)-vp3(2))+tem3*vp1(1)-tem2*vp3(1))/(tem3-tem2);

u0 = u00;

v00 = vp1(2)+tem3*(vp1(1)-u00);
v01 = vp2(2)+tem1*(vp2(1)-u01);
v02 = vp3(2)+tem2*(vp3(1)-u02);
